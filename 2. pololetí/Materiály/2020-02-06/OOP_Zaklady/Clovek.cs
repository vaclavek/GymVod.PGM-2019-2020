...
namespace OOP_Zaklady
{
    abstract class Clovek : IClovek
    {
        ...
        { 
            get 
            {
                return (int)Math.Floor(DateTime.Now.Subtract(DatumNarozeni).TotalDays / 365); 
            }
        }
        ...
        public virtual void Napis(string comamrict)
        {
        ...
        public abstract string CoDelasVPraci();
